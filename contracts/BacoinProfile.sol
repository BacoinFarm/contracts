...
// File: @bacoin/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/BacoinProfile.sol
...
*/
contract BacoinProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public bacoinToken;
    ...
    uint256 public numberBacoinToReactivate;
    uint256 public numberBacoinToRegister;
    uint256 public numberBacoinToUpdate;
    ...
    constructor(
        IBEP20 _bacoinToken,
        uint256 _numberBacoinToReactivate,
        uint256 _numberBacoinToRegister,
        uint256 _numberBacoinToUpdate
    ) public {
        bacoinToken = _bacoinToken;
        numberBacoinToReactivate = _numberBacoinToReactivate;
        numberBacoinToRegister = _numberBacoinToRegister;
        numberBacoinToUpdate = _numberBacoinToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends BACOIN to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer BACOIN tokens to this contract
        bacoinToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBacoinToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer BACOIN token to this address
        bacoinToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBacoinToUpdate
        );
    ...
    /**
     * @dev Claim BACOIN to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        bacoinToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of BACOIN to register
     * Callable only by owner admins.
     */
    function updateNumberBacoin(
        uint256 newNumberBacoinToReactivate,
        uint256 _newNumberBacoinToRegister,
        uint256 _newNumberBacoinToUpdate
    ) external onlyOwner {
        numberBacoinToReactivate = newNumberBacoinToReactivate;
        numberBacoinToRegister = _newNumberBacoinToRegister;
        numberBacoinToUpdate = _newNumberBacoinToUpdate;
    }
