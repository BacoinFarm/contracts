...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.bacoin = await MockBEP20.deployed();
        ...
        await this.bacoin.transfer(bob, '2000', { from: minter });
        await this.bacoin.transfer(alice, '2000', { from: minter });
        await this.bacoin.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.bacoin.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.bacoin.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.bacoin.balanceOf(this.lotteryProxyAddress)).toString(), '418');
